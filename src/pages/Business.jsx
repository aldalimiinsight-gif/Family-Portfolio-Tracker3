...
const defaultForm = {
  ...
  currency: 'USD', investmentDate: '', currentValuation: '', description: '',
};
...
export default function Business() {
  ...
  const openEdit = (b) => { setEditing(b.id); setForm({ ...b }); setModal(true); };
  ...
  const totals = useMemo(() => {
    ...
    return { capital, currentValue, pnl: currentValue - capital, pnlPct: capital > 0 ? ((currentValue - capital) / capital) * 100 : 0 };
  }, [business]);
    ...
    <div className="page-enter p-4 md:p-6 space-y-5">
      ...
      {business.length === 0 ? (
        <EmptyState
          ...
          action={
            <button onClick={openAdd} className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 rounded-lg text-white text-sm font-medium flex items-center gap-2">
      ...
      {/* Modal */}
      <Modal open={modal} onClose={() => setModal(false)} title={editing ? 'Edit Business' : 'Add Business Investment'}>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Gulf Tech Ventures LLC"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-slate-400 text-xs mb-1.5">Ownership % *</label>
              <input
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Company total value"
                className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white text-sm placeholder-slate-500 focus:outline-none focus:border-blue-500"
              />
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" className="flex-1 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 rounded-lg text-white text-sm font-medium">
